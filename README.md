...
Portanto, para rodar os testes no GitHub Actions, _realize uma alteração qualquer neste arquivo_ `README.md` e faça o commit da alteração com a seguinte mensagem: `Commit 1: Running the tests`.
